...
<!-- Положи PNG в docs/screenshots и раскомментируй нужные строки.
     Эти же файлы автоматически попадают в слайд-шоу установщика. -->
...
![MEP-инструменты](docs/screenshots/05-mep-tools.png)
-->

Подробнее — [docs/screenshots](docs/screenshots).
