...
- Кнопка **«Действия»** — забиндить то, чего нет на ленте: правый клик
  «Скрыть элемент/категорию», «Переопределить графику», «Показать скрытые
  элементы» (лампочка снизу), правка (удалить/копировать/переместить…).
  Действие выполняется над выделенным объектом
